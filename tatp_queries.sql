...
CREATE TABLE Access_Info (s_id INTEGER NOT NULL, ai_type TINYINT NOT NULL, data1 SMALLINT, data2 SMALLINT, data3 CHAR(3), data4 CHAR(5));
CREATE TABLE Special_Facility (s_id INTEGER NOT NULL, sf_type TINYINT NOT NULL, is_active TINYINT NOT NULL, error_cntrl SMALLINT, data_a SMALLINT, data_b CHAR(5));
CREATE TABLE Call_Forwarding (s_id INTEGER NOT NULL, sf_type TINYINT NOT NULL, start_time TINYINT NOT NULL, end_time TINYINT, numberx VARCHAR(15));
