...
use execution::logical_entities::aggregations::min::Min;
...
fn test_min_aggregate() {
    ...
    let hustle_calculation = sum_column_hustle(agg_relation.clone(), "MIN(a)");
    let sqlite3_calculation = run_query_sqlite3("SELECT MIN(t.a) FROM t;", "MIN(t.a)");
